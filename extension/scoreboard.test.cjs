...
function harness(options = {}) {
  ...
  return { calls, internal, content, send: (request = { scoreboard: { action: "fetch" } }, url = "https://fantasy420.web.app/scoreboard") => new Promise(resolve => {
...
test("rejects untrusted origins and malformed options before accessing ESPN", async () => {
  ...
  for (const [request, origin] of [
    ...
    [{ scoreboard: { action: "fetch", leagueId: "../123" } }, "https://fantasy420.web.app/"],
    [{ scoreboard: { action: "fetch", year: 1 } }, "https://fantasy420.web.app/"],
  ]) {
